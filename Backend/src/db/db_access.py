...
class DatabaseAccessAzure:
    ...
    def send(self, table_name, data):
        ...
        if table_name == "input_data":
            ...
            cursor.execute("INSERT INTO dbo.output_data (title, explanation, interpretation, confidence, deepfake, sentiment, sentiment_explanation, disinformation, disinformation_explanation, target_Audience, url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", data)
        elif table_name == "manual_data":
            cursor.execute("INSERT INTO dbo.manual_data (title, explanation, interpretation, confidence, deepfake, sentiment, sentiment_explanation, disinformation, disinformation_explanation, target_Audience) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", data)
        else:
